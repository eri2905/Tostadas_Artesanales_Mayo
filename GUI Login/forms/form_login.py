...
class App:
    ...
    def __init__(self):        
        ...
        label = tk.Label( frame_logo, image=logo,bg='orange' )
        ...
        inicio = tk.Button(frame_form_fill,text="Iniciar sesion",font=('Times', 15,BOLD),bg='orange', bd=0,fg="#fff",command=self.verificar)
